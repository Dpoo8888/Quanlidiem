<?php
require_once 'C:\xampp\htdocs\php_mvc-master\connect\connect.php';
...
switch ($controller) {
	case 'DangNhap':
		require_once 'C:\xampp\htdocs\php_mvc-master\controller\DangNhap.php';
		break;
	case 'ThongTinCaNhanHS':
		require_once 'C:\xampp\htdocs\php_mvc-master\controller\DiemMonHoc.php';
		break;
